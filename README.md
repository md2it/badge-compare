...
> A compact visual reference for choosing a default README badge style and source for a specific use case. 
> It compares representative badges only; it is not a complete feature matrix or provider documentation.
...
| Badgen | [![GitHub](https://badgen.net/badge/GitHub/-?icon=github)](https://github.com/badgen/badgen.net) | [![Stars](https://badgen.net/github/stars/badgen/badgen.net)](https://github.com/badgen/badgen.net/stargazers) | [![License](https://badgen.net/github/license/badgen/badgen.net)](https://github.com/badgen/badgen.net/blob/main/LICENSE.md) | [![badgen.net](https://badgen.net/badge/badgen.net/-)](https://badgen.net/help) |
...
| Source | Reddit | LinkedIn | Facebook | YouTube |
| --- | --- | --- | --- | --- |
| Shields.io | ![Reddit](https://img.shields.io/reddit/subreddit-subscribers/programming) | ![LinkedIn](https://img.shields.io/badge/LinkedIn-informational) | ![Facebook](https://img.shields.io/badge/Facebook-informational?logo=facebook) | [![YouTube](https://img.shields.io/youtube/channel/subscribers/UC_x5XG1OV2P6uZZ5FSM9Ttw)](https://youtu.be/dQw4w9WgXcQ) |
| Badgen | ![Reddit](https://badgen.net/badge/Reddit/-?icon=reddit) | ![LinkedIn](https://badgen.net/badge/LinkedIn/-) | ![Facebook](https://badgen.net/badge/Facebook/-?icon=facebook) | [![YouTube](https://badgen.net/badge/YouTube/-?icon=youtube)](https://youtu.be/dQw4w9WgXcQ) |
...
| Source | Python | JavaScript | Rust | Go |
| --- | --- | --- | --- | --- |
| Shields.io | ![Python](https://img.shields.io/badge/Python-informational?logo=python) | ![JavaScript](https://img.shields.io/badge/JavaScript-informational?logo=javascript) | ![Rust](https://img.shields.io/badge/Rust-informational?logo=rust) | ![Go](https://img.shields.io/badge/Go-informational?logo=go) |
| Badgen | ![Python](https://badgen.net/badge/Python/-?icon=python) | ![JavaScript](https://badgen.net/badge/JavaScript/-?icon=javascript) | ![Rust](https://badgen.net/badge/Rust/-?icon=rust) | ![Go](https://badgen.net/badge/Go/-?icon=go) |
...
| Source | npm | PyPI | Maven | Cargo |
| --- | --- | --- | --- | --- |
| Shields.io | ![npm](https://img.shields.io/npm/v/npm?logo=npm) | ![PyPI](https://img.shields.io/pypi/v/pip?logo=pypi) | ![Maven](https://img.shields.io/maven-central/v/com.google.guava/guava?logo=apachemaven) | ![Cargo](https://img.shields.io/crates/v/serde?logo=rust) |
| Badgen | ![npm](https://badgen.net/npm/v/badgen?icon=npm) | ![PyPI](https://badgen.net/pypi/v/pip?icon=pypi) | ![Maven](https://badgen.net/maven/v/metadata-url/repo1.maven.org/maven2/com/google/guava/guava/maven-metadata.xml?icon=apachemaven) | ![Cargo](https://badgen.net/crates/v/serde?icon=rust) |
...
| Source | Cloudflare | Docker Hub | AWS | Codex |
| --- | --- | --- | --- | --- |
| Shields.io | ![Cloudflare](https://img.shields.io/badge/Cloudflare-informational?logo=cloudflare) | ![Docker Hub](https://img.shields.io/docker/pulls/library/node?logo=docker) | ![AWS](https://img.shields.io/badge/AWS-informational) | ![Codex](https://img.shields.io/badge/Codex-informational) |
| Badgen | ![Cloudflare](https://badgen.net/badge/Cloudflare/-?icon=cloudflare) | ![Docker Hub](https://badgen.net/docker/pulls/library/node?icon=docker) | ![AWS](https://badgen.net/badge/AWS/-) | ![Codex](https://badgen.net/badge/Codex/-) |
